...
export const jupyterhubUsernameTranslate = (username: string) => 
  username.replace(/-/g, '-2d')
    .replace(/@/g, '-40')
    .replace(/\./g, '-2e')
    .replace(/:/g, '-3a');

export const generateNotebookNameFromUsername = (username: string) => `jupyter-nb-${jupyterhubUsernameTranslate(username)}`

export const generatePvcNameFromUsername = (username: string) => `jupyterhub-nb-${jupyterhubUsernameTranslate(username)}-pvc`;
